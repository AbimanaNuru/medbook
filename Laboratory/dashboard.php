...
$query = "SELECT * FROM laboratory_test where laboratory_user_id='$user_id' AND DATE(test_date_time)=CURDATE() ";
					...
					<div class="clearfix">
						<div class="pull-left">
							...
							<div class="col-sm-12 col-md-8">
								<input class="form-control"  name="search" autofocus id="search" autocomplete="off" required placeholder="Search Here By Card Number" type="text">
							</div>
						</div>
						<div id="output"></div>
